...
const demoList = [
  ...
  { title: 'Horizontal Layout', to: 'https://demos.pixinvent.com/vuexy-vuejs-laravel-admin-template/demo-5/dashboards/analytics' },
  { title: 'Bordered Layout', to: 'https://demos.pixinvent.com/vuexy-vuejs-laravel-admin-template/demo-2/dashboards/analytics' },
  { title: 'Semi Dark Layout', to: 'https://demos.pixinvent.com/vuexy-vuejs-laravel-admin-template/demo-3/dashboards/analytics' },
  { title: 'Dark Layout', to: 'https://demos.pixinvent.com/vuexy-vuejs-laravel-admin-template/demo-4/dashboards/analytics' },
]
</script>
